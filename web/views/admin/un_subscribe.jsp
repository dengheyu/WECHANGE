    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a>取消预约<span class="sr-only">(current)</span></a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
...
<div class="container">
    <div class="jumbotron">
        <form class="form-inline text-center" action="un_subscribe_ok.jsp">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="description" value="<%=rs.getString("kind")%>">
                </div>
