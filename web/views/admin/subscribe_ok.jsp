    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a>预约成功!<span class="sr-only">(current)</span></a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
<%
    ...
    try {
        ...
        //增加数据SQL语句
        stmt.executeUpdate("INSERT INTO subscribe(user_name,id) VALUES ('" + user_name + "', '" + id + "')");
    ...
    <div class="jumbotron">
        <div class="alert alert-success">
            <h2 class="text-center">
                恭喜你！商品已经预约成功，可点击“我的预约”查看上传人联系方式！
            </h2>
        </div>
    </div>
</div>
