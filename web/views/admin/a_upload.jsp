    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="/views/admin/a_upload.jsp?&user_name=<%=session.getAttribute("user_name").toString()%>" class="dropdown-toggle" role="button" aria-haspopup="true"
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a>我的上传<span class="sr-only">(current)</span></a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
    ...
    <div class="jumbotron">
        <%
            ...
            try {
                ...
                //执行SQL查询语句，返回结果集
                ResultSet rs = stmt.executeQuery("SELECT * FROM goods WHERE belonger = '"+user_name+"'");
                //成功则循环输出信息
        %>
        <table class="table table-bordered" align="center" width="800" border="1">
            <th align="center" colspan="6">
                <h2 class="text-center">我的上传</h2>
            </th>
            <tr align="center">
                <td>
                    <p>
            ...
            <tr align="center">
                ...
                <td>
                    <a class="btn btn-mini btn-success" href="/views/admin/un_upload.jsp?id=<%=rs.getString("id")%>">取消上传</a>
                </td>
            </tr>
            <%
                }
