    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="/views/admin/a_subscribe.jsp" class="dropdown-toggle" role="button" aria-haspopup="true"
    ...
    <div class="jumbotron">
        <%
            ...
            try {
                ...
                //执行SQL查询语句，返回结果集
                ResultSet rs = stmt.executeQuery("SELECT * FROM subscribe,goods WHERE subscribe.id=goods.id and subscribe.user_name='"+user_name+"'");
                //成功则循环输出信息
        %>
        <table class="table table-bordered" align="center" width="800" border="1">
            ...
            <tr align="center">
                ...
                <td>
                    <a class="btn btn-mini btn-success" href="/views/admin/un_subscribe.jsp?id=<%=rs.getString("id")%>">取消预约</a>
                </td>
            </tr>
            <%
                }
